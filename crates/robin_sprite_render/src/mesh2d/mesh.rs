...
use crate::{
    Material2dBindGroupId, PendingMeshMaterial2dQueues, RenderMaterial2dBindGroupIds,
    RenderMaterial2dIds, prepare_pending_mesh_material2d_queues, tonemapping_pipeline_key,
};
...
use robin_render::RenderSystems::PrepareAssets;
use robin_render::prelude::Msaa;
use robin_render::{
...
impl GetFullBatchData for Mesh2dPipeline {
    ...
    fn write_batch_indirect_parameters_metadata(
        ...
        indirect_parameters_buffer: &mut robin_render::batching::gpu_preprocessing::UntypedPhaseIndirectParametersBuffers,
...
pub fn prepare_mesh2d_view_bind_groups(
    ...
    for (entity, tonemapping) in &views {
        ...
        let (Some(view_binding), Some(globals)) = (
            ...
            globals_buffer.buffer.get_buffer_handle(frame_graph),
        ) else {
            return;
        };
